...
/*
Exercise:
Create a table for Movies database having columns ID, NAME, release year, country.
Insert 5 movies records into movie database and show them using simple jdbc also show them using SQL. Show all database operations on this table.
